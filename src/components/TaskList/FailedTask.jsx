  ...
  return (
    <>
      {tasks.map((task, index) => (
        <div key={index} className='h-full flex-shrink-0 w-[300px] p-5 bg-blue-700 rounded-xl'>
          ...
          <div className='flex justify-between mt-4'>
            <button className='w-full mt-4 rounded bg-red-500 py-1 px-2 text-sm'>Failed</button>
          </div>
        </div>
      ))}
    </>
